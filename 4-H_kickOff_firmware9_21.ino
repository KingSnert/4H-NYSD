...
char ssid [100]="Incredible Wearables unit3";
...
*/
  ...
  /*call soft ap with ssid, no pass, channel, and visible */
...
/*void giveSSID()
{
    ...
    strcpy (ssid, "ssid, Incredible Wearables unit1,const char* passphrase = NULL, int channel = 1, int ssid_hidden = 0");
